...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fType): ?>
<div
    x-data="{ visible: true }"
    x-show="visible"
...
>
    <div class="flex items-start gap-3 bg-white shadow-[0_8px_40px_rgba(0,0,0,0.13)] px-5 py-4
        <?php if($fType === 'success'): ?> border-l-4 border-[#0086da]
        <?php elseif($fType === 'error'): ?> border-l-4 border-red-500
        <?php else: ?> border-l-4 border-[#3d5a6e] <?php endif; ?>">

        
        <div class="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center
            <?php if($fType === 'success'): ?> bg-[#0086da]
            <?php elseif($fType === 'error'): ?> bg-red-500
            <?php else: ?> bg-[#3d5a6e] <?php endif; ?>">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fType === 'success'): ?>
        ...
        <div class="flex-1 min-w-0">
            <div class="text-[.68rem] font-black uppercase tracking-[.13em]
                <?php if($fType === 'success'): ?> text-[#0086da]
                <?php elseif($fType === 'error'): ?> text-red-500
                <?php else: ?> text-[#3d5a6e] <?php endif; ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fType === 'success'): ?> Success <?php elseif($fType === 'error'): ?> Error <?php else: ?> Notice <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="mt-0.5 text-[.82rem] font-medium leading-snug text-[#1a2e3b]"><?php echo e($fMsg); ?></div>
        </div>
    ...
    <div class="h-[2px] w-full
        <?php if($fType === 'success'): ?> bg-[#0086da]/20
        <?php elseif($fType === 'error'): ?> bg-red-500/20
        <?php else: ?> bg-[#3d5a6e]/20 <?php endif; ?>">
...
<?php /**PATH C:\JOELJOELJOELJOELJOEL\CLINIC\resources\views/components/flash-toast.blade.php ENDPATH**/ ?>
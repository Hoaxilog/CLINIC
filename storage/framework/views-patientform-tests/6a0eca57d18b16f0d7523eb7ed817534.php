    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showModal): ?>
        <div data-patient-form-modal class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-3 sm:p-6"
            x-data="patientFormDraftManager({
                userId: <?php echo \Illuminate\Support\Js::from((int) (auth()->id() ?? 0))->toHtml() ?>,
                mode: <?php echo \Illuminate\Support\Js::from($isEditing ? 'edit' : 'create')->toHtml() ?>,
                patientId: <?php echo \Illuminate\Support\Js::from($isEditing ? (int) ($newPatientId ?? 0) : 0)->toHtml() ?>,
                currentStep: <?php echo \Illuminate\Support\Js::from((int) $currentStep)->toHtml() ?>
            ...
            x-on:patient-form-navigation-started.window="captureLoadingStart($event.detail)"
            x-on:patient-form-navigation-finished.window="handleNavigationFinished($event.detail)"
            x-on:record-resolver-debug.window="captureRecordResolverDebug($event.detail?.payload)"
                ...
                <div class="relative flex max-h-[92vh] flex-col">
                    ...
                    <div class="border-b border-gray-200 bg-white px-4 py-4 sm:px-6">
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-y-3">
                                ...
                                <div
                                    <?php if($isEditing): ?> x-on:click.prevent="handleStepNavigation(1)" <?php endif; ?>
                                    class="flex items-center gap-2.5 transition <?php echo e($currentStep == 1 ? 'text-[#0086da]' : 'text-gray-400'); ?> <?php echo e($isEditing && $currentStep !== 1 ? 'cursor-pointer hover:text-[#0086da]' : ''); ?>">
                                    <span
                                        class="flex h-8 w-8 items-center justify-center rounded-sm border-2 <?php echo e($currentStep == 1 ? 'border-[#0086da] bg-[#e8f4fc]' : 'border-gray-300 bg-white'); ?> text-sm font-semibold">1</span>
                                ...
                                <div
                                    <?php if($isEditing && $canNavigateFromBasicInfo): ?> x-on:click.prevent="handleStepNavigation(2)" <?php endif; ?>
                                    class="flex items-center gap-2.5 transition <?php echo e($currentStep == 2 ? 'text-[#0086da]' : 'text-gray-400'); ?> <?php echo e($isEditing && $currentStep !== 2 && $canNavigateFromBasicInfo ? 'cursor-pointer hover:text-[#0086da]' : ''); ?> <?php echo e($basicInfoEditing ? 'cursor-not-allowed opacity-60' : ''); ?>">
                                    <span
                                        class="flex h-8 w-8 items-center justify-center rounded-sm border-2 <?php echo e($currentStep == 2 ? 'border-[#0086da] bg-[#e8f4fc]' : 'border-gray-300 bg-white'); ?> text-sm font-semibold">2</span>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAdmin): ?>
                                    ...
                                    <div
                                        <?php if($isEditing && $canNavigateFromBasicInfo): ?> x-on:click.prevent="handleStepNavigation(3)" <?php endif; ?>
                                        class="flex items-center gap-2.5 transition <?php echo e($currentStep == 3 ? 'text-[#0086da]' : 'text-gray-400'); ?> <?php echo e($isEditing && $currentStep !== 3 && $canNavigateFromBasicInfo ? 'cursor-pointer hover:text-[#0086da]' : ''); ?> <?php echo e($basicInfoEditing ? 'cursor-not-allowed opacity-60' : ''); ?>">
                                        <span
                                            class="flex h-8 w-8 items-center justify-center rounded-sm border-2 <?php echo e($currentStep == 3 ? 'border-[#0086da] bg-[#e8f4fc]' : 'border-gray-300 bg-white'); ?> text-sm font-semibold">3</span>
                                    ...
                                    <div
                                        <?php if($isEditing && $canNavigateFromBasicInfo): ?> x-on:click.prevent="handleStepNavigation(4)" <?php endif; ?>
                                        class="flex items-center gap-2.5 transition <?php echo e($currentStep == 4 ? 'text-[#0086da]' : 'text-gray-400'); ?> <?php echo e($isEditing && $currentStep !== 4 && $canNavigateFromBasicInfo ? 'cursor-pointer hover:text-[#0086da]' : ''); ?> <?php echo e($basicInfoEditing ? 'cursor-not-allowed opacity-60' : ''); ?>">
                                        <span
                                            class="flex h-8 w-8 items-center justify-center rounded-sm border-2 <?php echo e($currentStep == 4 ? 'border-[#0086da] bg-[#e8f4fc]' : 'border-gray-300 bg-white'); ?> text-sm font-semibold">4</span>
                    ...
                    <div data-form-scroll class="overflow-y-auto bg-[#f6fafd] px-4 py-5 sm:px-6 sm:py-6">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditing && !empty($visitHistoryList) && $currentStep >= 2 && $isReadOnly): ?>
                            <div class="mb-5 flex items-center justify-between rounded-md border border-[#cce3f5] bg-white px-8 py-3 shadow-sm">
                                ...
                                <select
                                    x-on:mousedown="primeNavigationLoading()"
                                    x-on:touchstart="primeNavigationLoading()"
                                    x-on:focus="primeNavigationLoading()"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $visitHistoryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        <option value="<?php echo e($visit['value']); ?>" <?php if($selectedVisitDate === $visit['value']): echo 'selected'; endif; ?>><?php echo e($visit['label']); ?></option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </select>
                            </div>

                            <div x-data="{ open: false }" class="mb-5 rounded-md border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-900">
                                <div class="flex items-center justify-between gap-3">
                                    <div class="font-semibold">Record Resolver Debug</div>
                                    <button type="button" @click="open = !open"
                                        class="rounded-sm border border-amber-300 bg-white px-2 py-1 font-semibold text-amber-800 hover:bg-amber-100">
                                        <span x-text="open ? 'Hide' : 'Show'"></span>
                                    </button>
                                </div>
                                <div x-show="open" x-cloak class="mt-3 space-y-2">
                                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                                        <div><span class="font-semibold">Selected:</span> <?php echo e($recordResolverDebug['selected_visit_date'] ?? '-'); ?></div>
                                        <div><span class="font-semibold">Parsed Moment:</span> <?php echo e($recordResolverDebug['parsed_visit_moment'] ?? '-'); ?></div>
                                        <div><span class="font-semibold">Health ID:</span> <?php echo e($recordResolverDebug['selected_health_history_id'] ?? '-'); ?></div>
                                        <div><span class="font-semibold">Dental ID:</span> <?php echo e($recordResolverDebug['selected_dental_chart_id'] ?? '-'); ?></div>
                                        <div><span class="font-semibold">Current Chart ID:</span> <?php echo e($recordResolverDebug['current_dental_chart_id'] ?? '-'); ?></div>
                                        <div><span class="font-semibold">Chart Key:</span> <?php echo e($recordResolverDebug['chart_key'] ?? '-'); ?></div>
                                        <div><span class="font-semibold">Health Matches:</span> <?php echo e($recordResolverDebug['health_match_count'] ?? '-'); ?></div>
                                        <div><span class="font-semibold">Dental Matches:</span> <?php echo e($recordResolverDebug['dental_match_count'] ?? '-'); ?></div>
                                        <div><span class="font-semibold">Health Resolved:</span> <?php echo e($recordResolverDebug['resolved_health_created_at'] ?? '-'); ?></div>
                                        <div><span class="font-semibold">Dental Resolved:</span> <?php echo e($recordResolverDebug['resolved_dental_created_at'] ?? '-'); ?></div>
                                        <div><span class="font-semibold">Health Window:</span> <?php echo e(($recordResolverDebug['health_window_start'] ?? '-') . ' -> ' . ($recordResolverDebug['health_window_end'] ?? '-')); ?></div>
                                        <div><span class="font-semibold">Dental Window:</span> <?php echo e(($recordResolverDebug['dental_window_start'] ?? '-') . ' -> ' . ($recordResolverDebug['dental_window_end'] ?? '-')); ?></div>
                                        <div><span class="font-semibold">Treatment Loaded:</span> <?php echo e(!empty($recordResolverDebug['treatment_record_loaded']) ? 'yes' : 'no'); ?></div>
                                    </div>
                                    <pre class="max-h-56 overflow-auto rounded-md border border-amber-200 bg-white p-3 text-[11px] leading-5"><?php echo e(json_encode($recordResolverDebug, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES)); ?></pre>
                                </div>
                            </div>

                            <div x-data="{ open: true }" class="mb-5 rounded-md border border-sky-200 bg-sky-50 px-4 py-3 text-xs text-sky-900">
                                <div class="flex items-center justify-between gap-3">
                                    <div class="font-semibold">Loading Debugger</div>
                                    <button type="button" @click="open = !open"
                                        class="rounded-sm border border-sky-300 bg-white px-2 py-1 font-semibold text-sky-800 hover:bg-sky-100">
                                        <span x-text="open ? 'Hide' : 'Show'"></span>
                                    </button>
                                </div>
                                <div x-show="open" x-cloak class="mt-3 space-y-2">
                                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                                        <div><span class="font-semibold">Overlay Active:</span> <span x-text="navigationLoading ? 'yes' : 'no'"></span></div>
                                        <div><span class="font-semibold">Started At:</span> <span x-text="loadingDebug.startedAtLabel || '-'"></span></div>
                                        <div><span class="font-semibold">Prime Count:</span> <span x-text="loadingDebug.primeCount"></span></div>
                                        <div><span class="font-semibold">Prepare Count:</span> <span x-text="loadingDebug.prepareCount"></span></div>
                                        <div><span class="font-semibold">Start Events:</span> <span x-text="loadingDebug.startedEvents"></span></div>
                                        <div><span class="font-semibold">Finish Events:</span> <span x-text="loadingDebug.finishedEvents"></span></div>
                                        <div><span class="font-semibold">Last Action:</span> <span x-text="loadingDebug.lastAction || '-'"></span></div>
                                        <div><span class="font-semibold">Last Detail:</span> <span x-text="loadingDebug.lastDetail || '-'"></span></div>
                                    </div>
                                    <pre class="max-h-56 overflow-auto rounded-md border border-sky-200 bg-white p-3 text-[11px] leading-5" x-text="JSON.stringify(loadingDebug.events, null, 2)"></pre>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStep == 1): ?>
                            <div class="<?php echo e($isReadOnly ? 'pointer-events-none' : ''); ?>">
                                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('patient.form.basic-info', ['data' => $basicInfoData]);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1904611449-0', $__key);
...
?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStep == 2 && $isEditing): ?>
                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('patient.form.health-history', ['data' => $healthHistoryData,'gender' => $basicInfoData['gender'] ?? null,'isReadOnly' => $isReadOnly,'historyList' => $healthHistoryList,'selectedHistoryId' => $selectedHealthHistoryId]);

$__keyOuter = $__key ?? null;

$__key = 'health-history';
$__componentSlots = [];

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1904611449-1', $__key);
...
?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStep == 3 && $isEditing && $isAdmin): ?>
...
[$__name, $__params] = $__split('patient.form.dental-chart', ['data' => $dentalChartData,'isReadOnly' => $isReadOnly,'history' => $chartHistory,'selectedHistoryId' => $selectedHistoryId,'isCreating' => $forceNewRecord,'patientAge' => $patientAge]);

$__keyOuter = $__key ?? null;

$__key = 'dental-chart-'.$chartKey;
$__componentSlots = [];

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1904611449-2', $__key);
...
?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStep == 4 && $isEditing && $isAdmin): ?>
                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('patient.form.treatment-record', ['data' => $treatmentRecordData ?? [],'isReadOnly' => $isReadOnly]);

$__keyOuter = $__key ?? null;

$__key = 'treatment-record-'.$chartKey;
$__componentSlots = [];

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1904611449-3', $__key);
...
?>
                    ...
                    <div class="border-t border-gray-200 bg-white px-4 py-4 sm:px-6">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditing && !$isReadOnly && $shouldShowSave): ?>
                            <div class="mb-4 rounded-md border border-gray-200 bg-[#f6fafd] p-4">
                                ...
                                <div class="mt-3 space-y-2">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['consentAuthorizationAccepted'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['consentTruthfulnessAccepted'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div class="order-2 flex flex-wrap items-center gap-3 sm:order-1">
                                <button data-draft-ignore
                                    ...
                                    <?php echo e($isEditing && !$isReadOnly ? 'Cancel Changes' : 'Close'); ?>

                                </button>
                            </div>

                            <div class="order-1 flex flex-wrap items-center justify-end gap-3 sm:order-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showEditButton): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showEditVisitButton): ?>
                                    <button wire:click="enableEditMode" type="button"
                                        class="inline-flex items-center gap-2 rounded-sm bg-[#0086da] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#0073a8]">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showNewRecordButton): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($shouldShowSave): ?>
                                    <button data-draft-ignore
                                        x-on:click="$dispatch('patient-form-draft-pause', { ms: 3000 })"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showNext): ?>
                ...
                window.patientFormDraftManager = function(config) {
                    return {
                        ...
                        handleNavigationFinished(detail) {
                            this.loadingDebug.finishedEvents += 1;
                            this.loadingDebug.lastAction = 'finish';
                            this.loadingDebug.lastDetail = JSON.stringify(detail || {});
                            this.pushLoadingDebugEvent('finish', detail || {});
                        ...
                        async handleVisitRecordSelection(event) {
                            ...
                            if (!value) {
                                this.loadingDebug.lastAction = 'record-change-skipped';
                                this.loadingDebug.lastDetail = 'empty value';
                                this.pushLoadingDebugEvent('record-change-skipped', {});
                                return;
                            }

                            await this.prepareNavigationLoading();
                            this.loadingDebug.lastAction = 'record-request-start';
                            this.loadingDebug.lastDetail = value;
                            this.pushLoadingDebugEvent('record-request-start', { value });

                            try {
                                await this.$wire.selectVisitRecord(value);
                                this.loadingDebug.lastAction = 'record-request-resolved';
                                this.loadingDebug.lastDetail = value;
                                this.pushLoadingDebugEvent('record-request-resolved', { value });
                                ...
                                this.loadingDebug.lastAction = 'record-request-error';
                                this.loadingDebug.lastDetail = error?.message || 'unknown error';
                                this.pushLoadingDebugEvent('record-request-error', {
                                    value,
                        ...
                        async prepareNavigationLoading() {
                            this.loadingDebug.prepareCount += 1;
                            this.loadingDebug.lastAction = 'prepare';
                            this.loadingDebug.lastDetail = 'prepareNavigationLoading()';
                            this.pushLoadingDebugEvent('prepare', {
                                currentStep: this.currentStep
                            });
                            this.primeNavigationLoading();

                            await new Promise((resolve) => requestAnimationFrame(resolve));
                            await new Promise((resolve) => requestAnimationFrame(resolve));
                        },

                        captureRecordResolverDebug(payload) {
                            this.recordResolverDebug = payload || {};
                            try {
                                console.debug('record-resolver-debug', this.recordResolverDebug);
                            } catch (error) {
                                // ignore console failures
                            }
                        },

                        primeNavigationLoading() {
                            this.loadingDebug.primeCount += 1;
                            this.loadingDebug.lastAction = 'prime';
                            this.loadingDebug.lastDetail = 'primeNavigationLoading()';
                            this.pushLoadingDebugEvent('prime', {
                                alreadyLoading: this.navigationLoading
                            });
                            ...
                            this.loadingDebug.startedAtLabel = new Date(this.navigationStartedAt).toLocaleTimeString();
                        },

                        captureLoadingStart(detail) {
                            this.navigationLoading = true;
                            this.navigationStartedAt = Date.now();
                            this.loadingDebug.startedAtLabel = new Date(this.navigationStartedAt).toLocaleTimeString();
                            this.loadingDebug.startedEvents += 1;
                            this.loadingDebug.lastAction = 'start-event';
                            this.loadingDebug.lastDetail = JSON.stringify(detail || {});
                            this.pushLoadingDebugEvent('start-event', detail || {});
                        },

                        pushLoadingDebugEvent(type, detail) {
                            const entry = {
                            ...
                            this.loadingDebug.events = [entry, ...this.loadingDebug.events].slice(0, 12);
                        },
...
<?php /**PATH C:\JOELJOELJOELJOELJOEL\CLINIC\resources\views/livewire/patient/form/patient-form-modal.blade.php ENDPATH**/ ?>
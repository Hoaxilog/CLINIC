        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden p-10 relative">
            ...
            <form method="POST" action="{{ route('users.update', $user->id) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="tel" name="contact" value="{{ old('contact', $user->contact) }}" placeholder="917 123 4567" maxlength="11" oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                ...
                <div class="mb-10 bg-blue-50 rounded-xl p-6 border border-blue-100">
                    <div class="mb-4">
                        <h3 class="text-sm font-extrabold text-[#0086DA] uppercase tracking-wide">Security Recovery</h3>
                        <p class="text-xs text-gray-500 mt-1 font-medium">Update the security question if needed.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                            ...
                            <div class="relative">
                                ...
                                <select name="security_question" class="w-full pl-10 pr-10 py-3 rounded-lg border-2 border-blue-200 focus:outline-none focus:border-[#0086DA] appearance-none bg-white transition duration-200 text-gray-700 font-medium text-sm">
                                    ...
                                    @foreach($questions as $q)
                                        <option value="{{ $q }}" {{ old('security_question', $user->security_question) == $q ? 'selected' : '' }}>
                                            {{ $q }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div>
                            <div class="relative">
                                ...
                                <input type="text" name="security_answer" placeholder="Type new answer (Leave blank to keep current)"

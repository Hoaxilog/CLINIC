    ...
    <aside id="sidebar" class="sidebar bg-white border-r border-gray-200 fixed left-0 top-14 bottom-0 overflow-hidden">
        <nav class="mt-10">
            <ul class="space-y-3">
                <li>
                    <a href="dashboard"
                        class="{{ request()->is('dashboard') ? 'active' : '' }} nav-item flex items-center gap-5 px-3 py-2 transition-colors relative group">
                        ...
                        <!-- Label -->
                        <span class="nav-text whitespace-nowrap text-xl">Dashboard</span>
                ...
                <li>
                    <a href="appointment" class="{{ request()->is('appointment') ? 'active' : '' }} nav-item flex items-center gap-5 px-3 py-2 transition-colors">
                        ...
                        <span class="nav-text whitespace-nowrap text-xl">Appointments</span>
                ...
                <li>
                    <a href="#" class="nav-item flex items-center gap-5 px-3 py-2 transition-colors">
                        ...
                        <span class="nav-text whitespace-nowrap text-xl">Patient Records</span>
                        <span class="tooltip absolute left-full ml-3 top-1/2 -translate-y-1/2 bg-gray-800 text-white text-sm rounded px-2 py-1 z-20 shadow-md">
                            Patient Records
                        </span>
                    </a>
                ...
                <li>
                    <a href="#" class="nav-item flex items-center gap-5 px-3 py-2 transition-colors">
                        ...
                        <span class="nav-text whitespace-nowrap text-xl">Charts</span>
                        <span class="tooltip absolute left-full ml-3 top-1/2 -translate-y-1/2 bg-gray-800 text-white text-sm rounded px-2 py-1 z-20 shadow-md">
                            Charts
                        </span>
                    </a>
        ...
        (function(){
            ...
            navItems.forEach(item => {
                item.addEventListener('click', function () {
                    this.classList.add('active', 'bg-[#0086DA]', 'text-white');
                });
            });

            // set initial active styling if present
            const active = document.querySelector('.nav-item.active');
            if (active) active.classList.add('bg-[#0086DA]', 'text-white');
        })();
    </script>
</body>
</html>
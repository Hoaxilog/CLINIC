                    ...
                    <a href="{{ route('home') }}" class="flex shrink-0 items-center gap-3 no-underline">
                        <div class="flex h-9 w-9 shrink-0 items-center justify-center">
                            <svg width="56" height="45" viewBox="0 0 56 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <mask id="brand-logo-mask-footer" mask-type="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="56" height="45">
                                    <path
                                ...
                                <g mask="url(#brand-logo-mask-footer)">
                                    <rect x="-25.5311" y="-23.4609" width="106.265" height="91.7739" fill="#FFFFFF" />
                                </g>
                            </svg>
                        </div>
                        <div class="leading-[1.25]">
                            <div class="text-[.88rem] font-extrabold tracking-[.05em] text-white">TEJADA CLINIC</div>
                            <div class="text-[.57rem] font-semibold uppercase tracking-[.2em] text-white/80">Dental Care</div>
                        </div>
                    </a>
                </div>

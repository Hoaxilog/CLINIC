    ...
    <div class="wrapper">
        <div class="container">
            <div class="hero">
                ...
                <p class="hero-copy">Your appointment request has been received. We will review it and notify you once
                    the schedule is confirmed.</p>
            </div>

            <div class="content">
                <h2 class="title">Appointment request received</h2>
                <p class="text">Hi {{ $name }}, thank you for booking with Tejadent Clinic. Here are the
                    details of your submitted appointment request.</p>
                ...
                <p class="text">We will send another update as soon as the clinic approves or adjusts your
                    appointment.</p>
                <p class="text" style="margin-bottom: 0;">If you did not request this appointment, you can ignore this
                    email.</p>

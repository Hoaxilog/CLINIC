...
<body>
    ...
    <main id="mainContent" class="min-h-screen bg-gray-100 p-6 lg:p-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
            ...
            <button class="absolute bottom-6 right-6 flex h-14 w-14 items-center justify-center rounded-full bg-[#ffac00] text-white shadow-lg transition hover:bg-yellow-500">

...
<head>
  ...
  <meta name="description" content="Orthodontics service at Tejada Dental Clinic." />
  <title>Orthodontics | Tejada Dental Clinic</title>
    ...
    <section class="relative overflow-hidden bg-white pb-20 pt-10 lg:pb-28">
      ...
      <div class="mx-auto max-w-[1800px] px-4 sm:px-6 lg:px-10">
        <div class="grid items-center gap-12 lg:grid-cols-2">
          <div class="reveal">
            <p class="mb-5 text-[11px] font-black uppercase tracking-[0.35em] text-brand-500">Service 03</p>
            <h1 class="mb-6 font-serif text-4xl font-bold leading-tight text-brand-deep lg:text-6xl">Orthodontics</h1>
            <p class="mb-10 max-w-2xl text-lg font-light leading-relaxed text-slate-500">Designing perfect alignment for both functional bite correction and aesthetic smile improvement.</p>
          ...
          <div class="reveal overflow-hidden rounded-[2.75rem] border-[12px] border-white bg-slate-100 shadow-2xl">
            <img src="https://images.unsplash.com/photo-1598256989800-fe5f95da9787?auto=format&fit=crop&w=1200&q=85" alt="Orthodontics consultation" class="h-[380px] w-full object-cover lg:h-[500px]">
          </div>
        </div>
      </div>
    </section>
    <section class="bg-[#f4fbff]/50 py-16 lg:py-24">
      <div class="mx-auto max-w-[1800px] px-4 sm:px-6 lg:px-10">
        ...
        <div class="grid gap-8 md:grid-cols-3">
          <div class="service-card reveal rounded-3xl bg-white p-8"><h3 class="mb-3 font-serif text-2xl font-bold text-brand-deep">Alignment Analysis</h3><p class="text-sm text-slate-500">Bite and spacing evaluation with treatment options.</p></div>
          <div class="service-card reveal rounded-3xl bg-white p-8"><h3 class="mb-3 font-serif text-2xl font-bold text-brand-deep">Appliance Planning</h3><p class="text-sm text-slate-500">Braces or aligner selection based on your case.</p></div>
          <div class="service-card reveal rounded-3xl bg-white p-8"><h3 class="mb-3 font-serif text-2xl font-bold text-brand-deep">Progress Monitoring</h3><p class="text-sm text-slate-500">Scheduled checks to ensure proper movement.</p></div>
        </div>
      </div>
    </section>
  </main>

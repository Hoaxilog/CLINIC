...
<body class="tracking-wide">
    ...
    <header id="adminHeader"
        class="fixed top-0 right-0 z-40 flex h-16 items-center justify-between border-b border-slate-200/90 bg-white px-4 shadow-sm transition-all duration-300"
        style="left:16rem;">
        ...
        <div class="flex items-center gap-2">
            ...
            <details class="relative">
                <summary
                    class="list-none cursor-pointer flex h-9 w-9 items-center justify-center rounded-sm border border-gray-200 bg-white text-gray-600 shadow-sm transition duration-200 hover:border-gray-400 hover:bg-gray-100 hover:text-black">
    ...
    <aside id="sidebar"
        ...
        {{-- Sidebar Logo --}}
        <div
            class="flex h-16 shrink-0 items-center justify-center border-b border-white/10 px-4 group-[.collapsed]:px-2">
            <a href="{{ route('dashboard') }}"
                ...
                <div
                    class="flex h-9 w-9 shrink-0 items-center justify-center group-[.collapsed]:h-10 group-[.collapsed]:w-10">
                    <svg width="40" height="32" viewBox="0 0 56 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <mask id="sidebar-logo-mask" mask-type="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="56"
                            height="45">
                            <path
                ...
                <div
                    class="overflow-hidden whitespace-nowrap leading-tight transition-all duration-300 group-[.collapsed]:w-0 group-[.collapsed]:opacity-0">
        ...
        <nav class="flex h-full w-full flex-col py-3 overflow-y-auto">
            <ul class="h-full w-full space-y-1 px-2">
                ...
                <li>
                    ...
                    @endphp
                    <button type="button" data-appointment-toggle title="Appointments"
                    ...
                    <li>
                        <a href="{{ route('users.index') }}" title="User Accounts"
                            ...
                            <span
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-square-user-icon lucide-square-user">
    ...
    <main id="adminMain" class="{{ $adminShellBaseClasses }} {{ $pageShellClasses }}"
        style="margin-left:16rem; padding-top:5.5rem;">
        @yield('content')
    </main>

...
<body class="tracking-wide">
    ...
    @else
    <header class="fixed top-0 left-0 right-0 z-50 flex h-14 items-center justify-between border-b border-slate-200/90 bg-white/95 px-3 sm:px-4 backdrop-blur">
                ...
                @if (auth()->user()->role === 3)
                    ...
                    <li>
                        <a href="{{ route('patient.dashboard') }}"
                            ...
                            <span class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-none bg-slate-100/90 text-slate-600 transition-colors duration-300 group-[.active]:bg-white/15 group-[.active]:text-white group-[.collapsed]:h-10 group-[.collapsed]:w-10 group-[.collapsed]:group-[.active]:bg-sky-100 group-[.collapsed]:group-[.active]:text-[#0086DA]">

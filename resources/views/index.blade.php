...
<body class="tracking-wide">
    ...
    @else
        <header
            class="fixed top-0 left-0 right-0 z-50 flex h-14 items-center justify-between border-b border-slate-200/90 bg-white/95 px-3 sm:px-4 backdrop-blur">
            <div class="flex items-center">
                <h2 class="text-base font-bold tracking-wide text-slate-900 sm:text-lg">Tejada Dent</h2>
            </div>
                    ...
                    @else
                        ...
                        <li>
                            ...
                            <button type="button" data-appointment-toggle
                                ...
                                <span
                                    class="nav-text whitespace-nowrap text-sm font-semibold tracking-wide overflow-hidden transition-all duration-300 group-[.collapsed]:w-0 group-[.collapsed]:opacity-0">Appointment</span>
                                <span
                        ...
                        @if (auth()->user()->role !== 3)
                            <li>
                                ...
                                group-[.collapsed]:[&.active]:bg-white group-[.collapsed]:[&.active]:text-[#0086DA] group-[.collapsed]:[&.active]:shadow-[0_8px_18px_-14px_rgba(0,134,218,0.65)]">
                                    ...
                                    <span
                                        class="nav-text whitespace-nowrap text-sm font-semibold tracking-wide overflow-hidden transition-all duration-300 group-[.collapsed]:w-0 group-[.collapsed]:opacity-0">Lobby
                                        Flow</span>
                                </a>
                            </li>
                        @endif

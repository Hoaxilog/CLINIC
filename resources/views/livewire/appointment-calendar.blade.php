<div class="relative ">
    ...
    <div class="w-full max-w-9xl mx-auto px-2 py-10 lg:px-8 overflow-x-auto bg-white mt-6">
        ...
        <div class="relative">
            {{-- This is the sticky header for the dates --}}
                ...
                <form class="p-6 overflow-y-auto" style="max-height: 80vh;" wire:submit.prevent="saveAppointment">
                    ...
                    <div class="mb-4 bg-gray-100 rounded-lg p-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" value="{{ Carbon\Carbon::parse($selectedTime)->format('h:i A') }}" class="w-full border-0 bg-transparent p-0 text-lg font-bold text-gray-900" readonly />
                            </div>
                            <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input wire:model.defer="firstName" type="text" class="w-full border rounded px-4 py-3 text-base" placeholder="John" />
                        ...
                        <div>
                            ...
                            <input wire:model.defer="middleName" type="text" class="w-full border rounded px-4 py-3 text-base" placeholder="(Optional)" />
                        ...
                        <div>
                            ...
                            <input wire:model.defer="lastName" type="text" class="w-full border rounded px-4 py-3 text-base" placeholder="Doe" />

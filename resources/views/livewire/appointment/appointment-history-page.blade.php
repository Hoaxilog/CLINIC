<div style="font-family:'Montserrat',sans-serif; -webkit-font-smoothing:antialiased;">
    ...
    <div class="appt-history-wrap space-y-5">
        ...
        <div class="border border-[#e4eff8] bg-white">
            ...
            <div class="grid grid-cols-1 gap-0 md:grid-cols-2 xl:grid-cols-5 divide-y md:divide-y-0 md:divide-x divide-[#e4eff8]">
                                    ...
                                    <div class="flex items-center gap-2.5">
                                        <div class="flex h-7 w-7 flex-shrink-0 items-center justify-center bg-[#f0f6fb]">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24"
                                                fill="none" stroke="#1a2e3b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <td class="px-5 py-4 max-w-[220px]">
                                    @if ($isCancelled && $appointment->reason_label)
                                        <div class="border-l-2 border-[#fca5a5] bg-[#fef2f2] px-3 py-2">
                                            <div class="text-[.7rem] leading-relaxed text-[#b91c1c]">{{ $appointment->reason_label }}</div>
                                        </div>
                                    @else
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-5 py-12 text-center">
                                    <div class="mx-auto max-w-sm border border-dashed border-[#d4e8f5] bg-[#f8fbfe] px-6 py-8">
                                        <div class="mx-auto mb-4 flex h-12 w-12 items-center justify-center bg-[#f0f6fb]">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
                                                stroke="#1a2e3b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <rect x="3" y="4" width="18" height="18" rx="0"/>
                                                <path d="M16 2v4M8 2v4M3 10h18"/>

<section class="space-y-8">
    @php
        ...
        $readonlyClass =
            'w-full rounded-lg border border-slate-200 bg-slate-100 px-3.5 py-2.5 text-sm text-slate-500';
    @endphp
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 md:p-6">
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
            <div>
                ...
                <input wire:model.defer="last_name" type="text" id="last_name" class="{{ $inputClass }}"
            ...
            <div>
                ...
                <input wire:model.defer="first_name" type="text" id="first_name" class="{{ $inputClass }}"
            ...
            <div>
                ...
                <input wire:model.defer="middle_name" type="text" id="middle_name" class="{{ $inputClass }}"
            ...
            <div>
                ...
                <input wire:model.defer="nickname" type="text" id="nickname" class="{{ $inputClass }}"
                    placeholder="e.g., Jun">
                @error('nickname')
            ...
            <div>
                ...
                <input wire:model.defer="occupation" type="text" id="occupation" class="{{ $inputClass }}"
            ...
            <div>
                ...
                <input wire:model.live="birth_date" type="date" id="birth_date" class="{{ $inputClass }}">
                @error('birth_date')
            ...
            <div>
                ...
                <input wire:model.defer="civil_status" type="text" id="civil_status" class="{{ $inputClass }}"
            ...
            <div class="md:col-span-2 xl:col-span-2">
                ...
                <input wire:model.defer="home_address" type="text" id="home_address" class="{{ $inputClass }}"
            ...
            <div>
                ...
                <input wire:model.defer="home_number" type="number" id="home_number" class="{{ $inputClass }}"
            ...
            <div class="md:col-span-2 xl:col-span-2">
                ...
                <input wire:model.defer="office_address" type="text" id="office_address" class="{{ $inputClass }}"
            ...
            <div>
                ...
                <input wire:model.defer="office_number" type="number" id="office_number" class="{{ $inputClass }}"
            ...
            <div>
                ...
                <input wire:model.defer="mobile_number" type="number" id="mobile_number" class="{{ $inputClass }}"
            ...
            <div>
                ...
                <input wire:model.defer="email_address" type="email" id="email_address" class="{{ $inputClass }}"
            ...
            <div class="md:col-span-2 xl:col-span-3">
                ...
                <input wire:model.defer="referral" type="text" id="referral" class="{{ $inputClass }}"
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
            <div>
                ...
                <input wire:model.defer="emergency_contact_name" type="text" id="emergency_contact_name"
                    class="{{ $inputClass }}" placeholder="e.g., Maria Dela Cruz">
            ...
            <div>
                ...
                <input wire:model.defer="emergency_contact_number" type="number" id="emergency_contact_number"
                    class="{{ $inputClass }}" placeholder="e.g., 0918 765 4321">
            ...
            <div>
                ...
                <input wire:model.defer="relationship" type="text" id="relationship" class="{{ $inputClass }}"
        ...
        <div class="rounded-2xl border border-amber-200 bg-amber-50/60 p-5 md:p-6">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                <div>
                    ...
                    <input wire:model.defer="who_answering" type="text" id="who_answering" class="{{ $inputClass }}"
                ...
                <div>
                    ...
                    <input wire:model.defer="relationship_to_patient" type="text" id="relationship_to_patient"
                        class="{{ $inputClass }}" placeholder="e.g., Mother">
                ...
                <div>
                    ...
                    <input wire:model.defer="father_name" type="text" id="father_name" class="{{ $inputClass }}"
                ...
                <div>
                    ...
                    <input wire:model.defer="father_number" type="number" id="father_number" class="{{ $inputClass }}"
                ...
                <div>
                    ...
                    <input wire:model.defer="mother_name" type="text" id="mother_name" class="{{ $inputClass }}"
                        placeholder="e.g., Maria Dela Cruz">
                    @error('mother_name')
                ...
                <div>
                    ...
                    <input wire:model.defer="mother_number" type="number" id="mother_number" class="{{ $inputClass }}"
                        placeholder="e.g., 0916 333 4444">
                    @error('mother_number')
                ...
                <div>
                    ...
                    <input wire:model.defer="guardian_name" type="text" id="guardian_name" class="{{ $inputClass }}"
                ...
                <div>
                    ...
                    <input wire:model.defer="guardian_number" type="number" id="guardian_number" class="{{ $inputClass }}"
                        placeholder="e.g., 0917 555 6666">

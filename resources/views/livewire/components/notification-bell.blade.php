    ...
    <template x-teleport="body">
        <div class="fixed inset-0 z-[5000] overflow-hidden pointer-events-none">
            ...
            <div class="flex h-full flex-col">
                ...
                <a href="{{ $footerLink }}" @click="open = false" class="block border-t border-slate-200 bg-white px-4 py-3 text-center text-sm font-semibold text-sky-700 transition-colors hover:bg-sky-50 hover:text-sky-800">
                    {{ $footerLabel }} ->
                </a>
            </div>
            </aside>

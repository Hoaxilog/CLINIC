<section class="min-h-[392px] border border-gray-200 bg-white p-6 shadow-sm" wire:poll.20s="loadCancelledAppointments">
    <div class="mb-4 flex items-start justify-between gap-4 border-b border-gray-100 pb-4">
        ...
        <a href="{{ route('appointment.history') }}"
            class="shrink-0 border border-slate-200 px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-700 transition hover:border-[#0086DA] hover:text-[#0086DA]">
            View All
        </a>
    </div>

                        ...
                        <div class="rounded-none border border-gray-200 bg-white p-6 shadow-sm">
                            ...
                            <div class="mt-5 flex flex-wrap gap-2">
                                <button type="button"
                                    ...
                                    class="rounded-sm bg-[#0086da] px-4 py-2 text-xs font-semibold text-white hover:bg-[#0073a8]">
                                    Add Health History
                                </button>
                                <button type="button"
                                    wire:click="$dispatch('editPatient', { id: {{ $selectedPatient->id }}, startStep: 3 })"
                                    class="rounded-sm border border-gray-200 bg-white px-4 py-2 text-xs font-semibold text-[#1a2e3b] hover:bg-[#f6fafd]">
                                    Dental Chart
                                </button>
                                <button type="button"
                                                ...
                                                <td class="px-5 py-4 text-right">
                                                    <div class="relative inline-block text-left"
                                                        ...
                                                        <div x-show="open" @click.away="open = false"
                                                            ...
                                                            style="display: none;">
                                                            <button type="button"
                                                                class="w-full px-4 py-2 text-left text-sm font-medium text-[#0086da] hover:bg-[#e8f4fc]"
